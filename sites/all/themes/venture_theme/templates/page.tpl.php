...
<div id="wrap">
        ...
        <li class="homepage-slider-slide">
            ...
            <div class="homepage-slide-inner container">
              ...
              <div class="homepage-slide-content">
                <div class="homepage-slide-title"><?php print $slide["titre"]; ?></div>
                <div class="clr"></div>
                <div class="homepage-slide-caption"><?php print $slide["sous_titre"]; ?></div>
              </div>
              
            </div>
            <img src="<?php print base_path() . 'sites/default/files/' . $slide['image']; ?>">
  ...
  <footer id="copyright-wrap" class="clear">
    <div id="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <a href="<?php print $front_page; ?>"><?php print $site_name; ?></a>. <?php print t('Développé par'); ?>  <a href="http://www.devsaran.com" title="Devsaran" target="_blank">Webstep</a>.</div>
  </footer>
</div>